...
def test_email():
	assert __standard.email_msg_status_from_arr == ['example.sender@example.com', 'None', 'None']
	assert __standard.email_msg_status_from == 'example.sender@example.com'
	assert __standard.email_msg_status_to_arr == ['example.recipient@example.com', 'SAS360CHAINING@example.com', 'SAS360CHAINING@example.com']
	assert __standard.email_msg_status_to == 'example.recipient@example.com'
	assert __standard.email_msg_support_from == 'example.sender@example.com'
	assert __standard.email_msg_support_to == 'example.recipient@example.com'
	assert __standard.email_msg_support_cc == 'example.recipient@example.com'
	assert __standard.email_server == 'smtp.gmail.com'
	assert __standard.email_server_login == 'example.sender@example.com'
...
def test_identities():
	...
	assert __standard.secret_key_arr == ['example-secret-key-dev', 'example-secret-key-test', 'example-secret-key-prod']
	assert __standard.secret_key == 'example-secret-key-dev'
